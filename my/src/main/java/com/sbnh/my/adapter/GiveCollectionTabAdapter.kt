...
class GiveCollectionTabAdapter(private val context: Context, private val data: List<GiveCollectionTabEntity>) :
    RecyclerView.Adapter<GiveCollectionTabAdapter.ViewHolder>() {
